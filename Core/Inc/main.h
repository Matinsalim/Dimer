...
#define DimmerSignal3_GPIO_Port GPIOA
#define DimmerSignal2_Pin GPIO_PIN_4
#define DimmerSignal2_GPIO_Port GPIOA
#define DimmerSignal1_Pin GPIO_PIN_5
#define DimmerSignal1_GPIO_Port GPIOA
#define ZeroCross_Pin GPIO_PIN_6
...
#define Pir_EXTI_IRQn EXTI4_15_IRQn
